...
void
litest_synaptics_clickpad_touch_down(struct litest_device *d, unsigned int slot, int x, int y)
{
...
void
litest_synaptics_clickpad_move(struct litest_device *d, unsigned int slot, int x, int y)
{
	struct input_event *ev;
